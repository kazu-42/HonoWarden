...
- `pnpm exec prettier --write test/compat/fixture-replay-support.ts test/compat/fixture-route-replay.test.ts docs/current-state.md docs/compatibility-matrix.md .workflow/week-26-prelogin-fixture-replay/**/*.md .workflow/week-26-prelogin-fixture-replay/state.json`:
  passed.
