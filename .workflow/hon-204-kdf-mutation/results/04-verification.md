...
- focused KDF/prelogin/app suite: 3 files, 309 tests
- `pnpm check`
- `pnpm lint`
- `pnpm format`
- `pnpm cf:typegen`
- `pnpm test`: 86 files, 1,041 tests
...
Three standard review passes found one P1 rollout defect, two P2 client
compatibility/enumeration defects, and then one P2 finite-decoy defect. The
complete-range HMAC remediation now passes every check above on its working
tree. A clean standard review and the independent five-axis review remain
pending and are not represented as passed here.
