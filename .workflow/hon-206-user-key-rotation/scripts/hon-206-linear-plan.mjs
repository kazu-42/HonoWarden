export const hon206LinearPlan = {
  ...
  issues: [
    ...
    },
    {
      ...
      scope: [
        'Order feature gate, authentication, bounded parser/account-key validation, notification preflight, credential-proof defense, snapshot validation, and D1 mutation.',
      ...
      acceptance: [
        ...
        'Old access/refresh/password generations fail; new token/profile/sync/backup read back one complete generation. Restart remains the real-D1 evidence packet.',
