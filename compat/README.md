...
| `account.password.change.client-readback`        | `account.password.change`        | `local_api`     | `local_official_client` | [account-password-change-local-evidence.md](../docs/release/account-password-change-local-evidence.md)              |
| `account.kdf.pbkdf2-to-argon2id.client-readback` | `account.kdf.pbkdf2_to_argon2id` | `local_api`     | `local_official_client` | [account-kdf-change-local-evidence.md](../docs/release/account-kdf-change-local-evidence.md)                        |
| `account.kdf.argon2id-to-pbkdf2.client-readback` | `account.kdf.argon2id_to_pbkdf2` | `local_api`     | `local_official_client` | [account-kdf-change-local-evidence.md](../docs/release/account-kdf-change-local-evidence.md)                        |
| `account.key.initialize.client-readback`         | `account.key.initialize`         | `local_api`     | `local_official_client` | [account-key-initialization-local-evidence.md](../docs/release/account-key-initialization-local-evidence.md)        |
...
| `account.user-key.rotate.client-readback`        | `account.user_key.rotate`        | `local_api`     | `local_official_client` | [user-key-rotation-local-evidence.md](../docs/release/user-key-rotation-local-evidence.md)                          |
