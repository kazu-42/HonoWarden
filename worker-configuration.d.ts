/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d229b8b6ec152a4a7870ca20304d653d)
...
interface __BaseEnv_Env {
	...
	HONOWARDEN_INQUIRY_DOMAIN: "honowarden.com";
	HONOWARDEN_INQUIRY_MAILBOXES: "security,support,hello,admin,postmaster,abuse,inquiry-smoke";
	GITHUB_TOKEN: string;
	CLOUDFLARE_API_TOKEN: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_ZONE_ID_HONOWARDEN_COM: string;
