...
Generate the alpha abuse report plan:
...
External alert routing and dashboards remain HON-50 work. Until that is
implemented, operators should paste only aggregate counts, hashed bucket tags,
timestamps, and runbook conclusions into evidence records.
