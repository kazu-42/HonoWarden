...
Selected deterministic stateless fixtures are also replayed against the Hono app
in CI so fixture assertions exercise real route behavior, not only static JSON
shape. Stateful token and mutation fixture replay remains separate follow-up
work.
...
| ----------------- | -------- | ----- | ----------------- | -------------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| browser_extension | 2026.6.1 |       | browser-v2026.6.1 | 2026-06-30T17:07:46Z | fixture_only | No live client login or sync run is recorded; TOTP login has local HTTP coverage only; read-only device lookup and preflight APIs are implemented (`GET /api/devices`, `GET /api/devices/identifier/:identifier`, `GET /api/devices/knowndevice`); metadata mutation and trust/key update APIs remain unsupported.                                        |
| desktop           | 2026.6.1 |       | desktop-v2026.6.1 | 2026-06-30T16:09:04Z | fixture_only | No live client login or sync run is recorded; TOTP login has local HTTP coverage only; read-only device lookup and preflight APIs are implemented (`GET /api/devices`, `GET /api/devices/identifier/:identifier`, `GET /api/devices/knowndevice`); metadata mutation and trust/key update APIs remain unsupported.                                        |
| mobile_android    | 2026.6.0 | 21686 | v2026.6.0-bwpm    | 2026-06-25T21:37:09Z | fixture_only | No live mobile login or sync run is recorded; TOTP login has local HTTP coverage only; read-only device lookup and preflight APIs are implemented (`GET /api/devices`, `GET /api/devices/identifier/:identifier`, `GET /api/devices/knowndevice`); metadata mutation and trust/key update APIs remain unsupported.                                        |
| mobile_ios        | 2026.6.0 | 3325  | v2026.6.0-bwpm    | 2026-06-26T15:03:00Z | fixture_only | No live mobile login or sync run is recorded; TOTP login has local HTTP coverage only; read-only device lookup and preflight APIs are implemented (`GET /api/devices`, `GET /api/devices/identifier/:identifier`, `GET /api/devices/knowndevice`); metadata mutation and trust/key update APIs remain unsupported.                                        |
| cli               | 2026.6.0 |       | cli-v2026.6.0     | 2026-06-25T18:32:52Z | live_smoke   | Live CLI smoke covers config, password login, empty sync, and revision lookup only; TOTP login has local HTTP coverage only; read-only device lookup and preflight APIs are implemented (`GET /api/devices`, `GET /api/devices/identifier/:identifier`, `GET /api/devices/knowndevice`); metadata mutation and trust/key update APIs are not implemented. |
